...
public class DBInfo {
	...
	public static class FOOD {
		...
		public static final String fd_one	= "제공량";
		...
		public static final String cp_cname= "제조사명";
		...
		public static final String it_group	= "분류명";
	...
	public static class 섭취정보 {
		...
		public final static String fd_one	= "제공량";
		...
		public final static String cp_cname	= "제조사명";
		...
		public final static String it_group	= "분류명";

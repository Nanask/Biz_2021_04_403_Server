		...
		.addEventListener("click", function(ev){
			...
			if(className == "btn_home") {
				...
				if(confirm("방명록을 삭제합니다")) {
					...
					// document.location.href = url 과
					// document.location.replace(url)
					
					// href는 새로운 페이지를 열고 URL에서 보여주는 정보를 보여준다
					// href는 새로운 페이지에서 뒤로가기를 하면 현재 페이지로 되돌아 올 수 있다.
					
					// replace() 현재 페이지에서 URL에서 res 한 정보를 보여준다
					// replace()는 새로운 페이지에서 뒤로가기를 했을 때 현재 페이지를 볼 수 없다.
